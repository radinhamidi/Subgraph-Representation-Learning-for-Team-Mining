...
from util.data_agent import *
import ml_metrics as metrics
import util.eval_function as dblp_eval

user_HIndex = get_preprocessed_user_HIndex()
user_skill_dict = get_user_skill_dict(
    load_preprocessed_dataset(file_path='../dataset/dblp_preprocessed_dataset.pkl'))
foldIDsampleID_strata_dict = get_foldIDsampleID_stata_dict(
    data=load_preprocessed_dataset(file_path='../dataset/dblp_preprocessed_dataset.pkl'),
    train_test_indices=load_train_test_indices(file_path='../dataset/Train_Test_indices.pkl'),
    kfold=10)
...
BL2009 = '../results/predictions/BL2009_output.csv'
BL2017 = '../results/predictions/BL2017_output.csv'
ME_M2V_SVAEO = '../results/predictions/ME_M2V_S_VAE_O_output.csv'
MET_M2V_SVAEO = '../results/predictions/MET_M2V_S_VAE_O_output.csv'


file_names = [MET_M2V_SVAEO, ME_M2V_SVAEO, BL2017, BL2009, RRN, SVDpp, Sapienza, Rad]
...
for file_name in file_names:
    ...
    result_output_name = "../results/scores/{}.csv".format(method_name)
