...
def pick_model_weights(model: keras.models.Model, dataset_name, path='../results/Models/Weights'):
    model_names = []
...
def load_T2V_model(model: Team2Vec, path='../results/Models/T2V'):
    model_names = []
...
def save_record(dict, dict_name, dir='../results/'):
